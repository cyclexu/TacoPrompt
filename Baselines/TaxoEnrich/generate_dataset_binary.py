import argparse
from data_loader.dataset import MAGDataset, Pseudo_MAGDataset

def main(args):
    binary_dataset = Pseudo_MAGDataset(name=args.taxon_name, path=args.data_dir, embed_suffix=args.embed_suffix, raw=True,
